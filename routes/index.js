...
var auth = jwt({secret:'SECRET', userProperty: 'payload'}); //TODO: Seceret should be an enviornment variable.
...
//@mdereje register a user given a username and password
...
//@mdereje add a login route. Uses localstrategy created in passport.js from the config folder.
